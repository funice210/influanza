...
all_df = pd.read_csv('E:\\probes_GSE52428matrix_ALL.txt',sep = '\t',encoding = 'utf-8')
...
Train4D_train_Features=train_Features.reshape(train_Features.shape[0],22277,1,1).astype('float32')
Test4D_test_Features=test_Features.reshape(test_Features.shape[0],22277,1,1).astype('float32')
...
model.add(Conv2D(filters=16,#建立16個濾鏡filter weight
                 ...
                 input_shape=(22277,1,1),#第1 2維度:代表輸入的影像形狀150x150大小，第3維度:最後維度是1
...
all_Features=all_Features.reshape(all_Features.shape[0],22277,1,1).astype('float32')
...
f1 = open('E:\Research\prediction100次結果\H1N1H3N2_CNN\H1N1H3N2_CNN_prediction.txt', 'a', encoding = 'UTF-8')
f2 = open('E:\Research\prediction100次結果\H1N1H3N2_CNN\H1N1H3N2_CNN_reality.txt', 'a', encoding = 'UTF-8')    
