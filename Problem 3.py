#dynamic programm for global alignment
import sys
print ("Enter the first sequence. Enter ctrl+d at the end")
a=sys.stdin.read()
a=a.replace("\n","")
print ("Enter the second sequence. Enter ctrl+d at the end")
b=sys.stdin.read()
b=b.replace("\n","")
al=len(a)
print ("lenghth of the first sequence is: ",al)
bl=len(b)
