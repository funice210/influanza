...
all_df = pd.read_csv('E:\probes_GSE52428matrix_ID_add0_origonal.txt',sep = '\t',encoding = 'utf-8')
...
while i<101:
    ...
    for j in range(predict.size):
        ...
        if(test_Label[j]==1 and predict[j]==0):
            ...
            FN=FN+0
    print(TP,TN,FP,FN,auc_roc,auc_pr)
    
    f1 = open('E:\Research\prediction100次結果\H3N2原始資料訓練_BaselinePrechellenge\H3N2_CNN_prediction_100x100x100.txt', 'a', encoding = 'UTF-8')
