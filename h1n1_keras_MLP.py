...
#all_df = pd.read_csv("C:/Users/yu-hao/Desktop/H1N1/PROTO_prob_gene+state.txt",sep='\t',encoding='utf-8')
#讀檔
all_df = pd.read_csv("E:\\rma_H3N2_ALL\\001_all.txt",sep='\t',encoding='utf-8')
#all_df = pd.read_csv("C:/Users/yu-hao/Desktop/H1N1/h1n1+h3n2.txt",sep='\t',encoding='utf-8')
#告知欄位
cols=['A/S','ID','1007_s_at','1053_at','117_at','121_at','1255_g_at','1294_at','1316_at','1320_at',
'1405_i_at','1431_at',
'1438_at','1487_at',
'1494_f_at','1598_g_at',
'160020_at','1729_at',
...
while i<101:                   
    ...
    model = Sequential()
    #輸入層
    model.add(Dense(units=100, input_dim=22277, 
    ...
    predict_probability=predict_probability[:16]
    ...
    precision, recall, thresholds = precision_recall_curve(test_Label, predict_probability)
    ...
    f1 = open('E:\\001T0_預測T0_H3N2.txt', 'a', encoding = 'UTF-8')
    f2 = open('E:\\001T0_單人樣本T0_H3N2.txt', 'a', encoding = 'UTF-8')
