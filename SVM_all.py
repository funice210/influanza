...
all_df = pd.read_csv('E:\\rma_H3N2_S.txt',sep = '\t',encoding = 'utf-8')
...
while i<101:   
    ...
    #f = open('E:\Research\prediction100次結果\SVM\SVM.txt', 'a', encoding = 'UTF-8')
    ...
    # 建立 SVC 模型 
    svc = svm.SVC( probability = True ,C = 32.0,  gamma=0.0001220703125)
    ...
    predict_probability=svc.predict_proba(test_Features)
    predict=predict_probability[:53]
    ...
    #f1 = open('E:\\Research\\prediction100次結果\\SVM\\rma_H3N2_80_0329_2.txt', 'a', encoding = 'UTF-8')
    f2 = open('E:\Research\prediction100次結果\SVM\\rma_H3N2_80_pro.txt', 'a', encoding = 'UTF-8')    
    # 也可使用指定路徑等方式，如： C:\A.txt
    #W會覆寫 a才不會 
